...
NSString* const SSUDirectoryUpdatedNotification = @"updatedDirectory";

NSString* const SSUDirectoryCategoryPeople = @"People";
NSString* const SSUDirectoryCategoryBuildings = @"Buildings";
NSString* const SSUDirectoryCategoryDepartments = @"Departments";
